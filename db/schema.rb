...
ActiveRecord::Schema.define(:version => 20131004084024) do
  ...
  add_index "actions", ["conversation_id", "created_at"], :name => "index_actions_on_conversation_id_and_created_at"
  ...
  create_table "conversations", :force => true do |t|
    ...
    t.datetime "created_at",                                            :null => false
    t.datetime "updated_at",                                            :null => false
    t.datetime "most_recent_action", :default => '2000-01-01 01:07:19'
  end
