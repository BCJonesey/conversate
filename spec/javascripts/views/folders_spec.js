describe("Folder list view", function() {
  ...
  it("has each folder's name", function() {
    expect(view.$('.tpc')[0].innerText.trim()).toEqual(folders[0].name);
    expect(view.$('.tpc')[1].innerText.trim()).toEqual(folders[1].name);
    expect(view.$('.tpc')[2].innerText.trim()).toEqual(folders[2].name);
  });
